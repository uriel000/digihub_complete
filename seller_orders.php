...
<?php include 'seller_header.php'?>
   <section class="orders">
    ...
    <div class="box-container">
      <?php
        $select_orders = mysqli_query($conn, "SELECT * FROM `orders` WHERE seller_id = '$seller_id' AND payment_status = 'pending'") or die("Query Failed");
        if(mysqli_num_rows($select_orders) > 0){
          while($fetch_orders = mysqli_fetch_assoc($select_orders)){
      ?>
      <div class="box">
        <p>E-shopper id: <span><?php echo $fetch_orders['user_id'];?></span></p>
  ...
  ?>
    ...
    <div class="box-container">
      <?php
        $select_orders = mysqli_query($conn, "SELECT * FROM `orders` WHERE seller_id = '$seller_id' AND payment_status = 'completed'") or die("Query Failed");
        if(mysqli_num_rows($select_orders) > 0){
          while($fetch_orders = mysqli_fetch_assoc($select_orders)){
      ?>
      <div class="box">
